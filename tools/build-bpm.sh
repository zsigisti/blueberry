#!/bin/sh
# build-bpm.sh — build native .bpm packages from packages/<name>/bpm.toml in an
...
#
# Usage:  tools/build-bpm.sh <out-dir> <pkgname>...
...
set -eu
OUT=${1:?usage: build-bpm.sh <out-dir> <pkg>...}; shift
